"""Legacy Excel warehouse UI, imported only after the user selects that mode."""
...
def render_legacy_excel_warehouse(
    *, file_hash, write_json_atomic, save_uploaded_copy, update_data_revisions, prepare_render_cache_cached
) -> None:
