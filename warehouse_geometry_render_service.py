...
def render_geometry_layers(
    ...
    *, model_id: str, revision_state_loader: Callable[[str], dict[str, Any]],
    static_token_loader: Callable[[dict[str, Any]], tuple],
    dynamic_token_loader: Callable[[dict[str, Any]], tuple],
    ...
    with measure_step("geometry_render_token"):
        ...
        static_token = None if revision_state.get("warning") else static_token_loader(model)
        dynamic_token = None if revision_state.get("warning") else dynamic_token_loader(model)
