...
- В разделе **«Карта склада»** можно построить карту либо по сохранённым Excel-объектам с координатами, либо напрямую загрузить Excel схемы рядов и выгрузку 1С для построения визуальной карты рядов.
